...
class Ui_pybb_MainWindow(object):
    def setupUi(self, pybb_MainWindow):
        ...
        pybb_MainWindow.resize(1500, 962)
        ...
        self.gridLayout_inputControl.addWidget(self.pushButton_parseVendor, 3, 3, 1, 1)

        self.horizontalSpacer = QSpacerItem(300, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_inputControl.addItem(self.horizontalSpacer, 1, 3, 1, 1)
        ...
        self.gridLayout_inputControl.addWidget(self.pushButton_loadNewReceipt, 0, 2, 1, 2)
        ...
        self.gridLayout_additionalData.addWidget(self.pushButton_parseData, 3, 2, 1, 1)
        ...
        self.dateEdit_shopDate.setMaximumDateTime(QDateTime(QDate(2222, 12, 31), QTime(18, 59, 59)))
        self.dateEdit_shopDate.setMinimumDateTime(QDateTime(QDate(2000, 1, 1), QTime(20, 0, 0)))
        ...
        self.gridLayout_additionalData.addItem(self.horizontalSpacer_2, 3, 1, 1, 1)
        ...
        self.gridLayout_additionalData.addItem(self.horizontalSpacer_3, 3, 0, 1, 1)
        ...
        self.gridLayout_saveReceipt.addWidget(self.pushButton_saveData, 0, 1, 1, 1)

        self.horizontalSpacer_4 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_saveReceipt.addItem(self.horizontalSpacer_4, 0, 0, 1, 1)
