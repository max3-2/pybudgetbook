...
class Ui_pybb_MainWindow(object):
    def setupUi(self, pybb_MainWindow):
        ...
        self.dateEdit_shopDate.setMaximumDateTime(QDateTime(QDate(2222, 12, 30), QTime(10, 59, 59)))
        self.dateEdit_shopDate.setMinimumDateTime(QDateTime(QDate(2000, 1, 1), QTime(12, 0, 0)))
        ...
        self.modernButton_loadPlotData.setMinimumSize(QSize(70, 72))
