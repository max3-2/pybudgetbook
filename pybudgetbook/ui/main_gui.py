...
class Ui_pybb_MainWindow(object):
    def setupUi(self, pybb_MainWindow):
        ...
        self.dateEdit_shopDate.setDateTime(QDateTime(QDate(2023, 4, 14), QTime(21, 0, 0)))
        self.dateEdit_shopDate.setMaximumDateTime(QDateTime(QDate(2222, 12, 30), QTime(9, 59, 59)))
        self.dateEdit_shopDate.setMinimumDateTime(QDateTime(QDate(2000, 1, 1), QTime(11, 0, 0)))
